...
(function () {
	var useToISOString = Date.prototype.toISOString ? true : false;
	...
	yerba.prototype = {
		...
		_setLastUpdate: function () {
			...
			this.lastUpdate = new Date()[ useToISOString ? 'toISOString' : 'getTime' ]();
		},
		...
		find: function ( obj ) {
			...
			*/
			...
			if ( isFunction( obj ) ) {
				...
				c.limit = typeof obj.limit !== 'undefined' ? obj.limit : c.limit;
